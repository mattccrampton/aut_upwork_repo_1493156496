...
const mapStateToProps = (state) => {
  ...
  return {...state["Homepage_TopBooks"], "XXX":"ZZZ"}
}
...
class TopBooksTopBooksComponent extends Component {
...
const TopBooksTopBooks = connect(mapStateToProps, mapDispatchToProps)(TopBooksTopBooksComponent)

export default TopBooksTopBooks
