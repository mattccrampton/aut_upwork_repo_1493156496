...
const mapStateToProps = (state) => {
  ...
  return {...state["Homepage_ThirdRow_RightList"], "XXX":"ZZZ"}
}
...
class RightListTopBooksComponent extends Component {
...
const RightListTopBooks = connect(mapStateToProps, mapDispatchToProps)(RightListTopBooksComponent)

export default RightListTopBooks
