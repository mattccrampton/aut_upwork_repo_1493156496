...
// Actions
const PRELOAD      = 'homepage/ThirdRow/RightList/PRELOAD';
const LOAD         = 'homepage/ThirdRow/RightList/LOAD';
const LOAD_SUCCESS = 'homepage/ThirdRow/RightList/LOAD_SUCCESS';
const LOAD_FAILURE = 'homepage/ThirdRow/RightList/LOAD_FAILURE';
...
export default function reducer(state = INITIAL_STATE, action = {}) {
  //console.log("homepage/ThirdRow/RightList reducer called", state, action);
  switch (action.type) {
    // do reducer stuff
    case PRELOAD:
