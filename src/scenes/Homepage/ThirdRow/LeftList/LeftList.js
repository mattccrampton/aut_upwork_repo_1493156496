...
const mapStateToProps = (state) => {
  ...
  return {...state["Homepage_ThirdRow_LeftList"], "XXX":"ZZZ"}
}
...
class LeftListTopBooksComponent extends Component {
...
const LeftListTopBooks = connect(mapStateToProps, mapDispatchToProps)(LeftListTopBooksComponent)

export default LeftListTopBooks
