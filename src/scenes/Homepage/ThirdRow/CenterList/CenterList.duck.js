...
// Actions
const PRELOAD      = 'homepage/ThirdRow/CenterList/PRELOAD';
const LOAD         = 'homepage/ThirdRow/CenterList/LOAD';
const LOAD_SUCCESS = 'homepage/ThirdRow/CenterList/LOAD_SUCCESS';
const LOAD_FAILURE = 'homepage/ThirdRow/CenterList/LOAD_FAILURE';
...
export default function reducer(state = INITIAL_STATE, action = {}) {
  //console.log("homepage/ThirdRow/CenterList reducer called", state, action);
  switch (action.type) {
    // do reducer stuff
    case PRELOAD:
